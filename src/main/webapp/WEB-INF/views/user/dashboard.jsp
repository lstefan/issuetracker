					...
					<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">
						  	...
						  	<c:forEach var="project" items="${projectsList}">
						  	 	<spring:url value="/dashboard/project/{projectId}" var="projectUrl">
              						<spring:param name="projectId" value="${project.id}"/>
          						</spring:url>
						  		<li><a href="${fn:escapeXml(projectUrl)}"> ${project.projectName}</a></li>
						  	</c:forEach>
							<li class="divider"></li>
							<li><a href="/dashboard/project/all">All projects</a></li>
						  </ul>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<ul class="nav nav-pills">
											    <spring:url value="/dashboard/{projectId}/{year}" var="currentYear">
											    	<spring:param name="projectId" value="${project.id}"/>
											    	<spring:param name="year" value="current"/>
											    </spring:url>
										    	<spring:url value="/dashboard/{projectId}/{year}" var="lastYear">
										    		<spring:param name="projectId" value="${project.id}"/>
