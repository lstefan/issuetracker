			...
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-6">
							...
							<div class="form-group">
								<label for="versions" class="col-sm-2 control-label"><fmt:message key="project.versions"/></label>
								<div class="col-sm-10">
							          
						          <form:select id="dropdown2" path="openOnVersion.name">
						          		<form:option value="">${currentVersion}</form:option>
						          </form:select>	
							...
							<div class="form-group">
								<label for="category" class="col-sm-2 control-label"><fmt:message key="issue.state"/></label>
								<div class="col-sm-10">
							...
							<div class="form-group" id="resolution"  style="display: none;">
								<label for="category" class="col-sm-2 control-label"><fmt:message key="issue.resolution"/></label>
								<div class="col-sm-10">
									
							          <form:select path="resolution">
							          	  <%-- <form:option value="issueSelection" label="--Please Select"/> --%>
							          	  <form:options items="${resolutionList}" />
							          </form:select>									
								</div>
							</div> 
							...
							<div class="form-group" id="fixed"  style="display: none;">
								...
								<div class="col-sm-10">
						          ...
						          <form:select id="dropdown3" path="fixedOnVersion.name">
						          		<form:option value="">${currentVersion}</form:option>
						          </form:select>	
